    ...
    <section class="content container-fluid">
        <div class="row">
            ...
            <div class="col-md-4" id="print_totaux">
                <div class="row">
                    <div class="col-xs-12">
                        <button class="btn btn-default" type="button" data-ajax="{{ $totaux_url }}"><span><i class="fa fa-calendar"></i></span> <i class="fa fa-caret-down"></i></button>
                    </div>
                </div>
            ...
            <div class="col-md-8" id="commande_evolution">
                <button class="btn btn-default" type="button" data-ajax="{{ $commande_evolution }}"><span><i class="fa fa-calendar"></i></span> <i class="fa fa-caret-down"></i></button>
